...
module.exports = function(context) {
     ...
     * @returns {void}
     */
    function validateCommaSpacing(items) {
    ...
    /**
     * Validates the spacing before and after commas.
     * @param {ASTNode[]} items The pair of nodes to check.
     * @private
     * @returns {void}
     */
    function validateParameterCommaSpacing(node) {
        var items = [];
    ...
    return {
        "FunctionExpression": validateParameterCommaSpacing,
        "FunctionDeclaration": validateParameterCommaSpacing,
